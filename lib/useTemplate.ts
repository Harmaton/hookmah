...
const sendEnvelopeFromTemplate = async (args: { basePath: any; accessToken: string; envelopeArgs: any; accountId: any; }) => {
...
function makeEnvelope(args: { templateId: any; signerEmail: any; signerName: any; ccEmail: any; ccName: any; }) {
  // Data for this method
  // args.signerEmail
  // args.signerName
  // args.ccEmail
