...
const NewUser = () => {
  ...
  useEffect(() => {
    ...
    const checkOrCreateUser = async () => {
      if (isSignedIn && user) {
        try {
          const response = await fetch('/api/users/user-init', {
            method: 'POST',
            headers: {
  ...
  <p className={`text-sm leading-relaxed text-slate-600 ${isExpanded ? '' : 'line-clamp-3'}`}>
              ...
              Hookmah ofrece cursos y contenidos (&quot;Ofertas de contenido&quot;) de universidades y otros proveedores (&quot;Proveedores de contenido&quot;). Si bien buscamos brindar ofertas de contenido de clase mundial por parte de nuestros proveedores de contenido, ocurren eventos inesperados. Hookmah se reserva el derecho de cancelar, interrumpir, reprogramar o modificar cualquier oferta de contenido, o cambiar el valor en puntos o el peso de cualquier tarea, prueba u otra evaluación, ya sea únicamente o de acuerdo con las instrucciones del proveedor de contenido. Las ofertas de contenido están sujetas a las secciones Descargo de responsabilidad y Limitación de responsabilidad que aparecen a continuación.
              
              
              Sin crédito académico
              Hookmah no otorga crédito académico por la finalización de las ofertas de contenido. Sin embargo realizamos convenios con instituciones educativas y universidades que sí pueden otorgar créditos, la participación o finalización de las Ofertas de Contenido no confiere ningún crédito académico. Incluso si el crédito lo otorga una institución, no hay presunción de que otras instituciones aceptarán ese crédito. Usted acepta no aceptar crédito por completar una Oferta de Contenido a menos que haya obtenido un certificado de curso u otra documentación equivalente de su finalización de la Oferta de Contenido. Hookmah, los instructores y los proveedores de contenido asociados no tienen la obligación de que ninguna institución educativa u organización de acreditación reconozca las ofertas de contenido.
              ...
              Los Servicios le permiten compartir su contenido, como tareas, pruebas, exámenes, proyectos, otras tareas que envíe, publicaciones que realice en los foros y similares (&quot;Contenido de usuario&quot;), con Hookmah, instructores y/o otros usuarios. Usted conserva todos los derechos de propiedad intelectual y es responsable del Contenido de usuario que crea y comparte. El Contenido de usuario no incluye el contenido del curso u otros materiales disponibles o colocados en la plataforma Hookmah por o en nombre de los Proveedores de contenido o sus instructores que utilizan los Servicios u Ofertas de contenido. Entre Hookmah y los proveedores de contenido, dichas ofertas de contenido se rigen por los acuerdos pertinentes vigentes entre Hookmah y los proveedores de contenido.
              
              
              Cómo Hookmah y otros pueden utilizar el contenido del usuario
              En la medida en que proporcione Contenido de usuario, otorga a Hookmah una licencia mundial totalmente transferible, libre de regalías, perpetua, sublicenciable, no exclusiva para copiar, distribuir, modificar y crear trabajos derivados basados en, realizar públicamente y exhibir públicamente. y utilizar de otro modo el Contenido del usuario. Esta licencia incluye otorgar a Hookmah el derecho de autorizar a los proveedores de contenido a utilizar el Contenido del usuario con sus estudiantes registrados, estudiantes en el campus u otros estudiantes independientes de los Servicios. Nada en estos Términos restringirá otros derechos legales que Hookmah pueda tener sobre el Contenido del usuario, por ejemplo, bajo otras licencias.
              ...
              Comentario
              Agradecemos sus sugerencias, ideas, comentarios y otros comentarios sobre los Servicios (&quot;Comentarios&quot;). Al enviar cualquier comentario, nos otorga el derecho de utilizar los comentarios sin ninguna restricción ni compensación para usted. Al aceptar sus comentarios, Hookmah no renuncia a ningún derecho a utilizar comentarios similares o relacionados previamente conocidos por Hookmah, desarrollados por nuestros empleados, contratistas u obtenidos de otras fuentes.
              
              
              
              4. SEGURIDAD
              
              Nos preocupamos por la seguridad de nuestros usuarios. Si bien trabajamos para proteger la seguridad de su cuenta y la información relacionada, Hookmah no puede garantizar que terceros no autorizados no puedan burlar nuestras medidas de seguridad. Notifíquenos de inmediato sobre cualquier compromiso o uso no autorizado de su cuenta enviando un correo electrónico a soy@SimpleLifeOfficial.com
              
              
              
              5. CONTENIDO DE TERCEROS
              
              A través de los Servicios, tendrá la posibilidad de acceder y/o utilizar contenido proporcionado por instructores, otros usuarios y/u otros terceros y enlaces a sitios web y servicios mantenidos por terceros. Hookmah no puede garantizar que dicho contenido de terceros, en los Servicios o en otros lugares, esté libre de material que usted pueda encontrar objetable o inapropiado o de malware u otros contaminantes que puedan dañar su computadora, dispositivo móvil o cualquier archivo que contenga. Hookmah renuncia a cualquier responsabilidad u obligación relacionada con su acceso o uso, o la imposibilidad de acceder o utilizar, dicho contenido de terceros.
              
              
              
              6. DERECHOS DE AUTOR Y MARCAS COMERCIALES
              
              Hookmah respeta los derechos de propiedad intelectual de nuestros usuarios, proveedores de contenido y otros terceros y espera que nuestros usuarios hagan lo mismo al utilizar los Servicios. Hemos adoptado e implementado la Política de marcas comerciales y derechos de autor de Hookmah a continuación de acuerdo con la ley aplicable, incluida la Ley de derechos de autor del milenio digital.
              
              
              
              7. INVESTIGACIÓN EN EDUCACIÓN
              
              Hookmah se compromete a promover la ciencia del aprendizaje y la enseñanza, y los registros de su participación en los cursos pueden usarse para investigaciones educativas. En interés de esta investigación, usted puede estar expuesto a variaciones en las ofertas de contenido. Los resultados de la investigación normalmente se informarán a nivel agregado. Su identidad personal no se divulgará públicamente en ningún resultado de investigación sin su consentimiento expreso.
              
              
              
              8. SERVICIOS PAGOS DE Hookmah
              
              Hookmah ofrece Servicios pagos (por ejemplo, certificados de cursos para ciertos cursos) por una tarifa. A menos que se indique lo contrario, las tarifas se cotizan en moneda local. Usted es responsable de pagar todas las tarifas cobradas por o para Hookmah y los impuestos aplicables de manera oportuna con un mecanismo de pago asociado con los Servicios pagos aplicables. Si su método de pago falla o su cuenta está vencida, podemos cobrar tarifas utilizando otros mecanismos de cobro. Las tarifas pueden variar según su ubicación y otros factores, y Hookmah se reserva el derecho de cambiar cualquier tarifa en cualquier momento a su exclusivo criterio. Cualquier cambio, actualización o modificación entrará en vigor inmediatamente después de su publicación a través de los Servicios correspondientes. Es posible que haya reembolsos disponibles para Servicios pagos como se describe en nuestra Política de pagos y reembolsos a continuación.
              
              
              Programas con Certificado Universitario
              Los Servicios pueden permitirle inscribirse en programas con Certificado Universitario o programas similares ofrecidos por nuestros Proveedores de Contenido en la plataforma Hookmah. Nuestros proveedores de contenido actúan como proveedores de educación a distancia de estos programas y determinan las políticas y requisitos de admisión, reembolso y graduación o finalización. Nada en estos Términos restringirá la aplicabilidad para usted de cualquier política institucional establecida por nuestro Proveedor de contenido en relación con estos programas (por ejemplo, códigos de conducta estudiantil); dichas políticas complementarán estos Términos y, en la medida en que exista un conflicto entre dichas políticas y estos Términos, entre usted y nuestro Proveedor de contenido, prevalecerán las políticas de nuestro Proveedor de contenido.
              
              Dependiendo del programa, Hookmah o nuestros socios de contenido pueden cobrar los pagos de matrícula y tarifas de estos programas. Si su método de pago falla o su cuenta está vencida, nosotros o nuestros Socios de Contenido podemos cobrar la matrícula y las tarifas utilizando otros mecanismos de cobro. La matrícula y las tarifas pueden variar según su ubicación y otros factores, y Hookmah y sus socios de contenido se reservan el derecho de cambiar cualquier matrícula y tarifas para semestres futuros o períodos de pago equivalentes a su exclusivo criterio. Es posible que haya reembolsos disponibles para Servicios pagos como se describe en nuestra Política de reembolso a continuación. Le recomendamos que investigue y considere si la matrícula y las tarifas requeridas para las ofertas de contenido se alinean con sus objetivos profesionales y financieros.
              
              La certificación y los requisitos laborales para diversas profesiones pueden variar en cada estado y país, y los requisitos laborales pueden variar según el empleador. Hookmah no garantiza la licencia, certificación o calificación para ninguna profesión o trabajo en función de la finalización de una oferta de contenido en Hookmah. Se le recomienda investigar, comprender y cumplir con los requisitos del estado y/o país correspondiente en el que trabaja o pretende trabajar, y que investigue si la Oferta de Contenido en la que pretende inscribirse satisface sus necesidades académicas y/o profesionales. antes de inscribirse.
              
              
              
              9. MODIFICAR O CANCELAR NUESTROS SERVICIOS
              
              Estamos constantemente cambiando y mejorando nuestros Servicios. Podemos agregar o eliminar funciones, características o requisitos, y podemos suspender (en la medida permitida por la ley aplicable) o detener parte de nuestros Servicios por completo. En consecuencia, Hookmah puede cancelar su uso de cualquier Servicio por cualquier motivo. Si se cancela su uso de un Servicio pago, es posible que haya un reembolso disponible según nuestra Política de reembolso. Es posible que no podamos prestar los Servicios a determinadas regiones o países por diversos motivos, incluso debido a requisitos de control de exportaciones aplicables o limitaciones y restricciones de acceso a Internet por parte de los gobiernos. Ninguno de Hookmah, sus proveedores de contenido e instructores, sus contribuyentes, patrocinadores y otros socios comerciales, ni sus empleados, contratistas y otros agentes (las &quot;Partes de Hookmah&quot;) tendrán responsabilidad alguna ante usted por dicha acción. Puede dejar de utilizar nuestros Servicios en cualquier momento, aunque lamentaremos que se vaya.
              
              
              
              10. DESCARGOS DE RESPONSABILIDAD
              
              EN LA MEDIDA MÁXIMA PERMITIDA POR LA LEY, LOS SERVICIOS Y TODO EL CONTENIDO INCLUIDO SE PROPORCIONAN &quot;TAL CUAL&quot; SIN GARANTÍA DE NINGÚN TIPO, YA SEA EXPRESA O IMPLÍCITA. LAS PARTES DE Hookmah RECHAZAN ESPECÍFICAMENTE CUALQUIER GARANTÍA Y CONDICIÓN DE COMERCIABILIDAD, IDONEIDAD PARA UN PROPÓSITO PARTICULAR Y NO INFRACCIÓN, Y CUALQUIER GARANTÍA QUE SURJA DEL CURSO DE LA NEGOCIACIÓN O DEL USO DEL COMERCIO. LAS PARTES DE Hookmah ADEMÁS RENUNCIA A TODA RESPONSABILIDAD RELACIONADA CON SU ACCESO O USO DE LOS SERVICIOS O CUALQUIER CONTENIDO RELACIONADO. USTED RECONOCE Y ACEPTA QUE CUALQUIER ACCESO O USO DE LOS SERVICIOS O DICHO CONTENIDO ES BAJO SU PROPIO RIESGO.
              
              
              
              11. LIMITACIÓN DE RESPONSABILIDAD
              
              EN LA MEDIDA MÁXIMA PERMITIDA POR LA LEY, LAS PARTES DE Hookmah NO SERÁN RESPONSABLES DE NINGÚN DAÑO INDIRECTO, INCIDENTAL, ESPECIAL, CONSECUENCIAL O PUNITIVO, NI DE CUALQUIER PÉRDIDA DE GANANCIAS O INGRESOS, YA SEA INCURRIDO DIRECTA O INDIRECTAMENTE, NI DE CUALQUIER PÉRDIDA DE DATOS, USO, BUENA VOLUNTAD U OTRAS PÉRDIDAS INTANGIBLES QUE RESULTEN DE: (A) SU ACCESO O USO O INCAPACIDAD DE ACCEDER O UTILIZAR LOS SERVICIOS; (B) CUALQUIER CONDUCTA O CONTENIDO DE CUALQUIER PARTE DISTINTA DE LA PARTE Hookmah CORRESPONDIENTE, INCLUYENDO SIN LIMITACIÓN, CUALQUIER CONDUCTA DIFAMATORIA, OFENSIVA O ILEGAL; O (C) ACCESO, USO O ALTERACIÓN NO AUTORIZADO DE SU CONTENIDO O INFORMACIÓN. EN NINGÚN CASO LA RESPONSABILIDAD TOTAL DE Hookmah POR TODAS LAS RECLAMACIONES RELACIONADAS CON LOS SERVICIOS SUPERARÁ LOS VEINTE DÓLARES ESTADOUNIDENSES ($20) O LA CANTIDAD TOTAL DE LAS TARIFAS RECIBIDAS POR Hookmah DE USTED POR EL USO DE LOS SERVICIOS PAGADOS DURANTE LOS ÚLTIMOS SEIS MESES, LO QUE SEA MAYOR.
              
              USTED RECONOCE Y ACEPTA QUE LAS EXENCIONES DE RESPONSABILIDAD Y LAS LIMITACIONES DE RESPONSABILIDAD ESTABLECIDAS EN ESTOS TÉRMINOS DE USO REFLEJAN UNA DISTRIBUCIÓN RAZONABLE Y JUSTA DE RIESGOS ENTRE USTED Y LAS PARTES DE Hookmah, Y QUE ESTAS LIMITACIONES SON UNA BASE ESENCIAL PARA LA CAPACIDAD DE Hookmah DE REALIZAR EL SERVICIOS DISPONIBLES PARA USTED DE FORMA ECONÓMICA FACIL.
              ...
              Usted garantiza que no se encuentra ni reside habitualmente en ningún país que esté sujeto a las leyes y regulaciones aplicables de los EE. UU. que impidan que Hookmah le brinde acceso a los Servicios. Su ubicación está determinada por su ubicación física. Está estrictamente prohibido el uso de un servicio de red privada virtual, servicios de enrutamiento IP u otro servicio similar con el fin de eludir estas leyes.
              ...
              Contiene contenido ilegal o promueve actividades ilegales con la intención de cometer dichas actividades. Tenga en cuenta que los usuarios de hasta 13 años utilizan Hookmah y no permitimos contenido que sea inapropiado para estos usuarios más jóvenes.
              ...
              Viole de otro modo los Términos de uso de Hookmah.
              ...
              Usar nuestros Servicios o cualquier funcionalidad de la plataforma Hookmah para cualquier otra finalidad que no sea completar cursos en línea o con fines pedagógicos.
              ...
              Si cree de buena fe que los materiales de la plataforma Hookmah infringen sus derechos de autor, la DMCA establece que usted (o su agente) puede enviarnos un aviso solicitando que se elimine el material o se bloquee el acceso a él.
              ...
              identificación del material que se afirma que infringe o es objeto de actividad infractora, e información razonablemente suficiente para permitir que Hookmah ubique el material en la plataforma;
              ...
              por correo: Agente de derechos de autor, Hookmah Marcelo T de Alvear 628, Piso 13, Córdoba – Argentina, Correo Postal X5000.
              ...
              Reembolsos generales: Hookmah no ofrece reembolsos por pagos realizados en un plan de suscripción de especialización mensual.
              
              Reembolsos por pruebas: Para evitar que se le cobre durante un período de prueba gratuito, debe cancelar su suscripción antes de que finalice la prueba gratuita. Si completa un curso durante el período de prueba gratuito, Hookmah se reserva el derecho de exigirle que pague una suscripción de un mes para poder recibir un curso y/o certificado de especialización.
              
              Cancelación: Su suscripción continuará mes a mes a menos y hasta que la cancele o Hookmah suspenda o interrumpa la suscripción. Si cancela su suscripción, la cancelación se hará efectiva al final del período mensual actual. Continuará teniendo acceso a su suscripción durante el resto de ese período, pero no recibirá un reembolso. Para suscripciones a especializaciones individuales, Hookmah suspenderá automáticamente su suscripción al final del período mensual durante el cual obtiene un certificado para la especialización.
              
              
              3. Hookmah
              
              Reembolsos generales: Para obtener un reembolso completo del pago de su suscripción a Hookmah Plus, envíe una solicitud de reembolso a través del Centro de ayuda para estudiantes dentro de los 14 días posteriores a su pago. No se proporcionarán reembolsos si se solicitan después de este período de 14 días.
              
              Reembolsos por pruebas: Algunas suscripciones de Hookmah Plus pueden tener un período de prueba gratuito en lugar de un período de reembolso. Si no cancela durante la prueba gratuita, se le facturará el monto total de la suscripción a la que se registró y no podrá solicitar un reembolso.
              
              Reembolsos por actualizaciones: Si actualiza de Hookmah Lite a Hookmah Plus, tiene 14 días a partir de la fecha de la actualización para que no se le cobre en la siguiente fecha de facturación o para recibir un reembolso.
              
              Cancelación: Su suscripción a Hookmah Plus continuará durante el período de suscripción identificado en el momento de su compra y luego se renovará automáticamente a menos y hasta que cancele su suscripción o Hookmah suspenda o descontinúe la suscripción. Si cancela su suscripción después del período de reembolso de su suscripción, seguirá teniendo acceso hasta el final del período de suscripción y no se le facturará para el siguiente ciclo de facturación.
              ...
              Uso de materiales no autorizados: usar o consultar materiales no autorizados (incluidos materiales electrónicos y herramientas de IA generativa que incluyen, entre otros, ChatGPT o software o aplicaciones similares) o usar equipos o dispositivos no autorizados en cualquier trabajo dentro de una actividad de Hookmah, a menos que expresamente permitido.
              Colaboración no autorizada: trabajar junto con cualquier persona en cualquier trabajo dentro de una actividad de Hookmah a menos que esté expresamente permitido.
              Hacer trampa en el contrato: pagar, intercambiar o conseguir de otro modo que otra persona cree un trabajo para enviarlo a un curso de Hookmah o para trabajar dentro de una actividad de Hookmah.
              Suplantación: completar el trabajo dentro de cualquier actividad de Hookmah (incluidos, entre otros, exámenes, evaluaciones y actividades de aprendizaje) cuando inicia sesión como otro usuario o hacer que otro usuario complete el trabajo dentro de una actividad de Hookmah cuando inicia sesión como usted; tergiversar de otro modo la autoría del trabajo presentado en Hookmah.
              ...
              Fraude: cualquier tergiversación sobre la autoría o las condiciones bajo las cuales se realizó el trabajo dentro de una actividad de Hookmah no especificada de otra manera o falsificar cualquier evidencia que respalde cualquier reclamo de circunstancias atenuantes.
              Otro: cualquier otro comportamiento que le confiera una ventaja injusta a usted o a otra persona o cualquier actividad que intente mejorar de manera deshonesta sus resultados o mejorar o dañar los resultados de otros en el desempeño del trabajo dentro de una actividad de Hookmah.
              
              
              CONSECUENCIAS PARA LOS PRODUCTOS NO CERTIFICADOS
              
              Hookmah determinará las sanciones pertinentes en función del tipo de mala conducta, la gravedad del comportamiento, lo que está en juego en la evaluación y cualquier historial previo de mala conducta por parte del usuario.
              
              No se emitirán reembolsos en caso de que se tomen medidas correctivas por dichas violaciones. Las violaciones del Código de Honor se determinarán a exclusivo criterio de Hookmah y los socios de Hookmah. Se le notificará si se ha determinado que ha violado este Código de Honor y se le informará de la acción correspondiente a tomar como resultado de la violación.
