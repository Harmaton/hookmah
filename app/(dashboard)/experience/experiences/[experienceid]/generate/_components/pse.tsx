...
const router = useRouter();
  ...
  async function aiRun() {
    ...
    const prompt =   ` Generate the Places of interests and curiosities of students according to the age that the teacher entered of this students. The age is (${age?.name}).
    ...
    try{
      ...
      const res =  await axios.patch(`/api/experience/${experienceid}/pse`, { text: JSON.stringify(text) });
      setisLoading(false);
      console.log(res)
  ...
  return (
    <div className="rounded-md p-4 border-red-200">
      ...
      {!isLoading && (
        ...
        >
          {initialData.psecharacteristics || "Sin características"}
        </p>
      )}
