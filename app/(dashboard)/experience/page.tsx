...
const Experiencepage = async () => {
  ...
  if (gaps.length === 0 ){
    ...
    <h1 className="text-3xl m-2 p-2 font-bold ">Bienvenido, primero debes crear una programación circular.</h1>
<Link href='/annual'>
    <Card className='border-red-500'>
      <CardHeader className='text-center font-bold'>
      Crea tu Primera Programación Anual para Crear una Experiencia de Aprendizaje
      </CardHeader>
      <CardContent>
      <Image 
      src='/empty-red.svg'
