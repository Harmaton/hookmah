...
const router = useRouter();
  ...
  async function aiRun() {
    ...
    offer 5 questions that motivate the student to explore the importance of touching on this topic in your learning, these questions must be related to your geographical context and its practical usefulness in life
    ...
    try{
      ...
      const res = await axios.patch(`/api/session/${sessionid}/kiadv`, { text: JSON.stringify(text) });
      setisLoading(false);
      console.log(res)
      ...
      {!isLoading && (
        <p
          className={cn(
            ...
            !initialData.knowinadvance && "text-slate-500 italic"
          )}
        >
          {initialData.knowinadvance || "Sin SABER CON ANTICIPACIÓN"}
        </p>
      )}
