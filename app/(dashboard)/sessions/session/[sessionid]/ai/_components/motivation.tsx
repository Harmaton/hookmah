...
const router = useRouter();
  ...
  async function aiRun() {
    ...
    try{
      ...
      const res = await axios.patch(`/api/session/${sessionid}/motivation`, { text: JSON.stringify(text) });
      setisLoading(false);
      console.log(res)
      ...
      {!isLoading && (
        <p
          className={cn(
            ...
            !initialData.motivation && "text-slate-500 italic"
          )}
        >
          {initialData.motivation || "Sin MOTIVACIÓN"}
        </p>
      )}
